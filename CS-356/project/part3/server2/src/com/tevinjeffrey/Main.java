...
public class Main {
    public static void main(String[] args) {
        ...
        router2.addLinkCost(router0.getNumber(), 3);
        router2.addLinkCost(router1.getNumber(), 1);
        router2.addLinkCost(router2.getNumber(), 0);
        router2.addLinkCost(router3.getNumber(), 2);

        System.out.println("Identity: " + router2);

        try {
            ServerSocket serverSocket = new ServerSocket(router2.getPort());
            ...
            System.out.println("Failed to bind to "+router2.getPort());
        }
    }
}
